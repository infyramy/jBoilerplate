...
const mockUsers = [
  ...
  { id: 2, name: 'Jane Smith', email: 'jane@example.com', role: 'user', status: 'active', created_at: '2023-02-20' },
  ...
  { id: 5, name: 'Charlie Wilson', email: 'charlie@example.com', role: 'user', status: 'suspended', created_at: '2023-05-12' },
  ...
  { id: 9, name: 'Grace Lee', email: 'grace@example.com', role: 'user', status: 'active', created_at: '2023-09-14' },
...
function impersonateUser(user: any) {
  ...
  try {
    ...
    const userToImpersonate = {
      ...
      uuid: `user-${user.id}`,
      email: user.email,
      user_type: user.role as 'admin' | 'user',
      fullname: user.name,
