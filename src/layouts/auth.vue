...
// Initialize color mode and system config
    ...
    >
      ...
      >
        <div class="absolute inset-0 bg-zinc-900">
          <img
            v-if="systemConfigStore.config.loginImage"
            :src="systemConfigStore.config.loginImage"
            alt="Authentication"
            class="h-full w-full object-cover opacity-30"
          />
          <div v-else class="h-full w-full flex items-center justify-center opacity-20">
        ...
        <div class="relative z-20 flex items-center text-lg font-medium">
          <img
            v-if="systemConfigStore.loginLogo"
            :src="systemConfigStore.loginLogo"
            :alt="systemConfigStore.config.systemName"
            :class="systemConfigStore.loginLogoSizeClass"
            :style="systemConfigStore.loginLogoStyle"
            class="h-auto object-contain"
          />
          <div v-else class="text-2xl font-bold">
            {{ systemConfigStore.config.systemName }}
          </div>
        </div>
