...
<template>
  <div>
    ...
    <DropdownMenu>
          ...
          <SidebarMenuItem>
            <SidebarMenuButton size="lg" class="data-[state=open]:bg-sidebar-accent data-[state=open]:text-sidebar-accent-foreground">
              <Avatar class="h-8 w-8 rounded-lg">
                ...
                <AvatarFallback class="rounded-lg">{{ authStore.user?.fullname?.charAt(0) ?? 'U' }}</AvatarFallback>
              </Avatar>
              <div class="grid flex-1 text-left text-sm leading-tight">
                <span class="truncate font-semibold">{{ authStore.user?.fullname ?? 'User' }}</span>
      ...
      <DropdownMenuContent class="w-[--radix-dropdown-menu-trigger-width] min-w-56 rounded-lg" side="top" align="start" :sideOffset="8">
